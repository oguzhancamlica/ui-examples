            ...
            <div className="m-5" style={{width:1050, zIndex:1}}>
                <div className="row">
                    <div className={`col-lg-4 col-md-6 ${style.col1}`} style={{backgroundColor:"rgba(251, 137, 107, 1)", borderTopLeftRadius:20}}>
                        ...
                        <h6 className='d-flex align-items-center size-17 mb-4'><Image src="/icons/search-icon.png" className='me-2' width={18} height={18}/> 
                        Search</h6>
                    ...
                    <div className="text-white px-4 pt-5 pb-3 mx-1 my-4">
                        <h6 className='d-flex align-items-center size-17 mb-4'> <Image src="/icons/cro-icon.png" className='me-2' width={18} height={18}/> <span>CRO</span> </h6>
                    ...
                    <div className="text-white px-4 pt-5 pb-3 mx-1 my-4">
                        <h6 className='d-flex align-items-center size-17 mb-4'> <Image src="/icons/social.png" className='me-2' width={18} height={18}/> <span>Social Media</span> </h6>
                        <ul className='size-13 text-capitalize'>
